...
{
    public class SignerenoAddonservicesModelsGeneratedCodePersonInfoScoring : INotifyPropertyChanged 
    {
        // These fields hold the values for the public properties.
        private string beslutningField;
        private List<SignerenoAddonservicesModelsGeneratedCodePersonInfoArsaksData> arsaksDataField;
        ...
        public List<SignerenoAddonservicesModelsGeneratedCodePersonInfoArsaksData> ArsaksDataField 
        { 
            get 
            {
