...
{
    public class SignerenoAddonservicesModelsGeneratedCodeForetakinfoScoring : INotifyPropertyChanged 
    {
        // These fields hold the values for the public properties.
        private string beslutningField;
        private List<SignerenoAddonservicesModelsGeneratedCodeForetakinfoArsaksData> arsaksDataField;
        ...
        public List<SignerenoAddonservicesModelsGeneratedCodeForetakinfoArsaksData> ArsaksDataField 
        { 
            get 
            {
