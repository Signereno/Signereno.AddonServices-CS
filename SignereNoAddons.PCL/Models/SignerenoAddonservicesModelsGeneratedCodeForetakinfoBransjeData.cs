...
{
    public class SignerenoAddonservicesModelsGeneratedCodeForetakinfoBransjeData : INotifyPropertyChanged 
    {
        // These fields hold the values for the public properties.
        private int? bransjeKodeField;
