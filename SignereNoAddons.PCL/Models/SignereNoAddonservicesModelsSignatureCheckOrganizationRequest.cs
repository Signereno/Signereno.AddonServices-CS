...
{
    public class SignereNoAddonservicesModelsSignatureCheckOrganizationRequest : INotifyPropertyChanged 
    {
        // These fields hold the values for the public properties.
        private string orgNumber;
        private bool? prokura;
        private bool? signature;
        private List<SignereNoAddonservicesModelsSignatureCheckCheckSignature> signatures;
        ...
        public List<SignereNoAddonservicesModelsSignatureCheckCheckSignature> Signatures 
        { 
            get 
            {
